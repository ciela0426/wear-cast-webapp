...
*/
  ...
  */
      ...
      */
          ...
          const sunriseTimeKST = new Date(
            sunriseTimeUTC.getTime() - 9 * 60 * 60 * 1000 + 9 * 60 * 60 * 1000
          ); // UTC 시간에서 9시간을 빼고 다시 9시간을 더하여 한국 시간으로 변환
          const sunriseHour = sunriseTimeKST
            .getHours()
            .toString()
            .padStart(2, "0"); // getHours()를 사용하여 한국 시간의 시간을 가져옴
          const sunriseMinute = sunriseTimeKST
            .getMinutes()
            .toString()
          ...
          const sunsetTimeKST = new Date(
            sunsetTimeUTC.getTime() - 9 * 60 * 60 * 1000 + 9 * 60 * 60 * 1000
          ); // UTC 시간에서 9시간을 빼고 다시 9시간을 더하여 한국 시간으로 변환
          const sunsetHour = sunsetTimeKST
            .getHours()
            .toString()
            .padStart(2, "0"); // getHours()를 사용하여 한국 시간의 시간을 가져옴
          const sunsetMinute = sunsetTimeKST
            .getMinutes()
            .toString()
            .padStart(2, "0"); // getMinutes()를 사용하여 한국 시간의 분을 가져옴
          ...
          const todayWeatherDescElement =
            document.getElementById("todayWeatherDesc");
          const todayWeatherTempElement =
            document.getElementById("todayWeatherTemp");
          const todayHumidElement = document.getElementById("todayHumid");
          const todaysunriseTimeElement =
          ...
          todayWeatherTempElement.innerHTML =
...
function displayWeatherInfo(weatherData) {
  ...
  if (rainAmount > 0) {
    document.getElementById(
      "WeatherInfo"
    ).innerHTML = `${rainAmount}<span>mm</span>`;
  } else {
